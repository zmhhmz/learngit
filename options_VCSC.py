...
def set_opts():
    ...
    parser.add_argument('--clip_grad', type=float, default=1e4,
                                             help="Cliping the gradients for Net, (default: 1e4)")
    ...
    parser.add_argument('--log_dir', default='./log_VCSC1', type=str, metavar='PATH',
                                                 help="Path to save the log file, (default: ./log)")
    parser.add_argument('--model_dir', default='./model_VCSC1', type=str, metavar='PATH',
    ...
    # hyper-parameters
    parser.add_argument('--eps2', default=1e-2, type=float,
